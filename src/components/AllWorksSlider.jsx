    ...
    <section>
        <div className="hidden lg:block lg:h-[600px] mt-[45px] py-[45px] relative lg:overflow-hidden rounded-lg lg:flex-col items-center justify-center">
                ...
                <div className="bg-white w-[90%] lg:max-w-[380px] p-8 rounded-lg absolute lg:right-0 lg:top-[50%] lg:translate-y-[-50%] z-10 shadow-xl">
                    ...
                    <span className="font-light italic text-sm text-center">by {selectedWork.designerName}</span>
                ...
                >
                    {
                        works.map((work, index) =>(
                            <SwiperSlide className="" key={index} onClick={() => setSelectedWork(work)}>
                                    <div className="w-full">
                                        <div className="w-full flex flex-col rounded-lg lg:h-[300px]">
                                            <div className="rounded-lg overflow-hidden h-[100%] hover:shadow-xl hover:scale-[105%]">
                                                <img className="rounded-lg object-cover object-center h-[100%]" src={`../images/works-designers/${work.photo}`} alt={work.short_description} />
                                            </div>
                                            <div className="rounded-lg p-4 flex items-center justify-between">
                                                <Link to={`/designers/${work.designerId}`}>
                                                    <span className="p-2 text-white text-[10px] lg:text-sm rounded-lg" style={{backgroundColor: 'var(--blue-color)'}}>@{work.designerId}</span>
                                                </Link>
