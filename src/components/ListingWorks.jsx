    ...
    <section>
       ...
       <div className="w-full py-[45px] mt-10">
         <Swiper
            ...
            className="mySwiper w-full h-[500px] lg:h-[450px] "
            breakpoints={{
                320:{
                slidesPerView: 1,
                spaceBetween: 5,
            ...
            >
                {
                    work.works.map((project, index) =>(
                        <SwiperSlide className="" key={index} onClick={() => setSelectedWork(project)}>
                                <div className="w-full">
                                    <div className="w-full flex flex-col rounded-lg h-[450px] lg:h-[300px]">
